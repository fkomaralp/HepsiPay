...
use Fkomaralp\HepsiPay\Model\RegisterCardResource;

class RegisterCardResourceMapper extends HepsipayResourceMapper
{
    public static function create($rawResponse = null)
    {
        return new RegisterCardResourceMapper($rawResponse);
    }

    public function mapRegisterCardResourceFrom(RegisterCardResource $resource, $jsonObject)
    {
    ...
    public function mapRegisterCardResource(RegisterCardResource $resource)
    {
        return $this->mapRegisterCardResourceFrom($resource, $this->jsonObject);
    }
}